...
using Constants = BKDelivery.CallCenter.Helpers.Constants;
...
namespace BKDelivery.CallCenter.Model
{
    public class NotificationElement
    {
        ...
        public NotificationElement(DialogType type, string message, ObservableCollection<UIElement> notificationsCollection, int? time = null)
        {
            ...
            _border.Margin = new Thickness(4);
        ...
        public void ManualUpdate(double percentage)
        {
            _progressBar.Value = _progressBar.Maximum * percentage;
            if (Math.Abs(_progressBar.Value - _progressBar.Maximum) < 0.00001) Hide();
        }
